    ...
    <>
      ...
      <Section delay={0.1}>
        ...
        <Box display={{ lg: "flex" }}>
          <Box w={{ lg: "55%" }}>
            <Text mb={5}>
              I&apos;m Pham Minh Viet, a student from Vietnam ❤️. I&apos;m major
              in software engineer. I build web applications, mobile
        ...
        <Box display={{ lg: "flex" }}>
          <Box w={{ lg: "45%" }} ml={{ xl: "9rem" }}>
            ...
            <Text>
              ...
              <strong> read books, philosophy</strong> is my favorite genre and
              I love Niezsche works
            </Text>
            <Text>
